# -*- coding: utf-8 -*-
"""cloze_modal handler (learning-types layer2, capability_id=cloze_modal).

Flow: present cloze card text (blanks shown as markers) -> modal N-blank input -> grade per blank -> feedback.
discord import OK.
"""
...
class _ClozeModal(discord.ui.Modal):
    def __init__(self, title: str, blank_count: int, future: asyncio.Future) -> None:
        ...
        for i in range(min(blank_count, 5)):  # modal supports at most 5 fields
