// aws 플러그인 ActivitySpec 데이터 — 목업 시드 (cycle-3 r2)
// plugin_id: "aws" · 서비스 분포: S3(3) · Lambda(2) · IAM(2) · DynamoDB(2) · SQS(2) = 11개
// checks: resource-exists 11개 + config-equals 4개 (총 15 checks)
// 원본: 규격/aws/_목업액티비티.js (C3 정합본)
...
window.ACTIVITIES['aws'] = [
  ...
  // [서비스: S3]
  {
    ...
    "grading": {
      "grader": "boto3",
      "checks": [
        { "type": "resource-exists", "service": "s3", "identifier": "lab-practice-bucket-2026" }
      ]
    }
  },
  ...
  // [서비스: S3]
  {
    ...
    "grading": {
      "grader": "boto3",
      "checks": [
        { "type": "resource-exists", "service": "s3", "identifier": "lab-versioned-bucket" },
        { "type": "config-equals",   "service": "s3", "identifier": "lab-versioned-bucket",
  ...
  // [서비스: S3]
  {
    ...
    "back": {
      ...
      "explanation": "퍼블릭 액세스 차단은 4가지 설정으로 구성됨. 신규 버킷은 기본적으로 모두 true이지만 명시적 설정 권장. ACL과 버킷 정책 두 경로 모두 차단해야 완전 비공개."
    },
    "grading": {
      "grader": "boto3",
      "checks": [
        { "type": "resource-exists", "service": "s3", "identifier": "lab-private-bucket" },
        { "type": "config-equals",   "service": "s3", "identifier": "lab-private-bucket",
  ...
  // [서비스: IAM]
  {
    ...
    "grading": {
      "grader": "boto3",
      "checks": [
        { "type": "resource-exists", "service": "iam", "identifier": "lab-lambda-exec-role" }
      ]
    }
  },
  ...
  // [서비스: IAM]
  {
    ...
    "grading": {
      "grader": "boto3",
      "checks": [
        { "type": "resource-exists", "service": "iam", "identifier": "lab-dev-user" }
      ]
    }
  },
  ...
  // [서비스: Lambda]
  {
    ...
    "grading": {
      "grader": "boto3",
      "checks": [
        { "type": "resource-exists", "service": "lambda", "identifier": "lab-hello-function" }
      ]
    }
  },
  ...
  // [서비스: Lambda]
  {
    ...
    "grading": {
      "grader": "boto3",
      "checks": [
        { "type": "resource-exists", "service": "lambda", "identifier": "lab-config-function" },
        { "type": "config-equals",   "service": "lambda", "identifier": "lab-config-function",
  ...
  // [서비스: DynamoDB]
  {
    ...
    "grading": {
      "grader": "boto3",
      "checks": [
        { "type": "resource-exists", "service": "dynamodb", "identifier": "lab-users-table" }
      ]
    }
  },
  ...
  // [서비스: DynamoDB]
  {
    ...
    "grading": {
      "grader": "boto3",
      "checks": [
        { "type": "resource-exists", "service": "dynamodb", "identifier": "lab-posts-table" }
      ]
    }
  },
  ...
  // [서비스: SQS]
  {
    ...
    "grading": {
      "grader": "boto3",
      "checks": [
        { "type": "resource-exists", "service": "sqs", "identifier": "lab-task-queue" }
      ]
    }
  },
  ...
  // [서비스: SQS]
  {
    ...
    "grading": {
      "grader": "boto3",
      "checks": [
        { "type": "resource-exists", "service": "sqs", "identifier": "lab-dlq" },
        { "type": "resource-exists", "service": "sqs", "identifier": "lab-main-queue" },
        { "type": "config-equals",   "service": "sqs", "identifier": "lab-main-queue",
