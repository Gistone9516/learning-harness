# -*- coding: utf-8 -*-
"""recall_self 핸들러 (학습타입규격 layer2, capability_id=recall_self).

흐름: 앞면 카드 제시 -> 정답보기 버튼 -> Yes(correct)/No(incorrect) 자가판정 -> HandlerResult.
discord import OK (handlers/ 폴더는 허용).
"""
